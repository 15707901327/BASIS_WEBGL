...
var LIGHT_X = 0, LIGHT_Y = 40, LIGHT_Z = 2; // Position of the light source
...
/**
 * 初始化一个帧缓冲对象，其中包含一个纹理对象和一个渲染缓冲对象
 * @param gl
 * @return {*}
 */
