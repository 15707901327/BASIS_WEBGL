...
var FSHADER_SOURCE =
    ...
    'vec3 smoothcolor(float s,float t,float s_min,float s_max,vec3 beginRGB,vec3 endRGB){\n' +
    ...
    '  vec3 color = smoothcolor(s,0.0,0.3,0.8,vec3(0.6,0.6,0.0),vec3(0.6,0.121,0.0));\n' +
