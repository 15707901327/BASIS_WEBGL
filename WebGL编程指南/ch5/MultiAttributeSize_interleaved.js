...
function initVertexBuffers(gl) {
  ...
  var a_PosintSize = gl.getAttribLocation(gl.program, 'a_PointSize');
  if (a_PosintSize < 0) {
    console.log('Failed to get the storage location of a_PointSize');
    return;
  }
  gl.vertexAttribPointer(a_PosintSize, 1, gl.FLOAT, false, FSIZE * 3, FSIZE * 2);
  gl.enableVertexAttribArray(a_PosintSize);
